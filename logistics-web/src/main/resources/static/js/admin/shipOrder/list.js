...
$(function () {
    ...
    $("#btn-del").click(function () {
        ...
        shipOrderManage.deleteItem(arrItemId);
    });

    $("#btn-simple-search").click(function () {
        shipOrderManage.fuzzySearch = true;
...
//      _table.draw(false);
    ...
    $("#btn-advanced-search").click(function () {
        shipOrderManage.fuzzySearch = false;
        _table.draw();
    });

    $("#btn-save-add").click(function () {
        shipOrderManage.addItemSubmit();
    });

    $("#btn-save-edit").click(function () {
        shipOrderManage.editItemSubmit();
    });
    ...
    $("tbody", $table).on("click", "tr", function (event) {
        ...
        //获取该行对应的数据
        var item = _table.row($(this).closest('tr')).data();
        shipOrderManage.currentItem = item;
        shipOrderManage.showItemDetail(item);
    });
    ...
    $table.on("change", ":checkbox", function () {
        ...
        shipOrderManage.currentItem = item;
        shipOrderManage.editItemInit(item);
    }).on("click", ".btn-del", function () {
        //点击删除按钮
        var item = _table.row($(this).closest('tr')).data();
        $(this).closest('tr').addClass("active").siblings().removeClass("active");
        shipOrderManage.deleteItem([item]);
    });
    ...
    $("#btn-view-edit").click(function () {
        shipOrderManage.editItemInit(shipOrderManage.currentItem);
    });

    $(".btn-cancel").click(function () {
        shipOrderManage.showItemDetail(shipOrderManage.currentItem);
    });
});
...
var shipOrderManage = {
    ...
    getQueryCondition: function (data) {
        ...
        //组装查询参数
        param.fuzzySearch = shipOrderManage.fuzzySearch;
        if (shipOrderManage.fuzzySearch) {
            ...
            param.expressNumber = $("#expressNumber").val();
        }
        //组装分页参数
